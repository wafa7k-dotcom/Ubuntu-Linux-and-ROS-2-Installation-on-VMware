...
**Large Number of Ubuntu Updates**
...
**ROS 2 Repository Was Not Available by Default**
...
**ROS Environment Needed to Be Loaded**
...
- **01-ubuntu-vmware** — Figure 1 – Ubuntu desktop running inside VMware Workstation
...
- **02-network-test** — Figure 2 – Network configuration test (ip a, ping)
...
- **03-apt-update** — Figure 3 – Running sudo apt update
...
- **04-ubuntu-upgrade** — Figure 4 – Running sudo apt upgrade -y
...
- **05-packages-update** — Figure 5 – Package list update in progress
...
- **06-package-installation** — Figure 6 – Package installation in progress
...
- **07-ros-repository** — Figure 7 – Configuring the ROS 2 repository and installing ros-humble-desktop
...
- **08-ros2-test** — Figure 8 – Final verification with ros2 topic list
